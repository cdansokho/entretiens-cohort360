...
/** Number of filter criteria currently set (excludes ordering, page, page_size). */
export function countActiveFilters(filters: PrescriptionFilters): number {
...
export function hasActiveFilters(filters: PrescriptionFilters): boolean {
...
export const FORM_INPUT_BASE =
  "w-full rounded-lg border bg-card px-3 py-2 text-sm shadow-sm focus:ring-1 outline-none transition";
